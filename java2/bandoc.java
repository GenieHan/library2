...
public class bandoc {
    ...
    public void nhap(){
        ...
        this.mabandoc = sc.nextLine();
            ...
            this.mabandoc = sc.nextLine();       
        }while(bdapp.checkma(mabandoc)==true);
    ...
    public  void hienthi(){
        System.out.printf("%-10s%-25s%-15s%-10s%-20s%-15s%-25s%-15s%-15s\n",this.mabandoc,this.hoten,this.ngaysinh,this.gioitinh,this.diachi,this.sdt,this.email,this.ngaydangki,this.sochungminh);
